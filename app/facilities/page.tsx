          ...
          <div className="divide-y divide-[#f0ede7]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-0 py-12 group">
              ...
              <div className="md:col-span-4 pr-8">
                ...
                <h3 className="text-2xl font-bold text-[#101F46] mb-3">21 Classrooms</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-0 py-12">
              ...
              <div className="md:col-span-4 pr-8">
                <div className="w-8 h-0.5 bg-amber-400 mb-4" />
                <h3 className="text-2xl font-bold text-[#101F46] mb-3">Computer Lab</h3>
                <p className="text-[#4b5563] text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-0 py-12">
              ...
              <div className="md:col-span-4 pr-8">
                <div className="w-8 h-0.5 bg-amber-400 mb-4" />
                <h3 className="text-2xl font-bold text-[#101F46] mb-3">Science Laboratories</h3>
                <p className="text-[#4b5563] text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-0 py-12">
              ...
              <div className="md:col-span-4 pr-8">
                <div className="w-8 h-0.5 bg-amber-400 mb-4" />
                <h3 className="text-2xl font-bold text-[#101F46] mb-3">230-Seat Auditorium</h3>
                <p className="text-[#4b5563] text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-0 py-12">
              ...
              <div className="md:col-span-4 pr-8">
                <div className="w-8 h-0.5 bg-amber-400 mb-4" />
                <h3 className="text-2xl font-bold text-[#101F46] mb-3">Moot Court</h3>
                <p className="text-[#4b5563] text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-0 py-12">
              ...
              <div className="md:col-span-4 pr-8">
                <div className="w-8 h-0.5 bg-amber-400 mb-4" />
                <h3 className="text-2xl font-bold text-[#101F46] mb-3">Cafeteria</h3>
                <p className="text-[#4b5563] text-sm leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-amber-400 text-[#101F46] font-bold text-sm hover:bg-amber-300 transition-colors"
              >
                Visit E-Library
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              >
                ...
                <div>
                  <h3 className="font-bold text-[#101F46] text-base mb-2">{item.title}</h3>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="bg-[#101F46] p-8 lg:p-10">
      ...
      <section className="py-24 bg-[#f7f5f0]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
              <h3 className="text-xs font-bold text-[#101F46] uppercase tracking-[0.15em] mb-5">Sports</h3>
              <div className="flex flex-wrap gap-2">
                {["Badminton", "Swimming", "Basketball", "Table Tennis", "Futsal", "Cricket", "Chess", "Tug-of-War", "Fun Races"].map((s) => (
                  <span
                    key={s}
                    className="px-3 py-1.5 bg-[#101F46] text-white text-xs font-medium"
                  >
                    {s}
                  </span>
                ))}
            ...
            <div>
              <h3 className="text-xs font-bold text-[#101F46] uppercase tracking-[0.15em] mb-5">Events &amp; Competitions</h3>
              <div className="flex flex-wrap gap-2">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center px-7 py-3.5 bg-amber-400 text-[#101F46] font-bold text-sm hover:bg-amber-300 transition-colors"
              >
                Schedule a Visit
              </Link>
              <Link
