...
export default function Admissions() {
  ...
  return (
    <main className="bg-white pt-[100px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-amber-400 text-[#101F46] font-bold rounded-xl hover:bg-amber-300 transition-colors shadow-lg shadow-amber-400/20"
                >
                  Contact Admissions
                  <IconArrow />
                </Link>
      ...
      <section className="bg-amber-400 py-6">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-[#101F46] font-bold text-lg leading-tight">
                Entrance Examination Information
              </p>
              <p className="text-[#101F46]/70 text-sm mt-0.5">
          ...
          <Link
            href="/contact"
            className="shrink-0 inline-flex items-center gap-2 px-7 py-3 bg-[#101F46] text-white font-bold rounded-xl hover:bg-[#162e57] transition-colors whitespace-nowrap"
          >
            Contact Admissions
            <IconArrow size={16} />
          </Link>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
            <div>
              ...
              <h2 className="text-xl font-bold text-[#101F46]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl">
            ...
            >
              <div className="w-12 h-12 bg-amber-400 flex items-center justify-center shrink-0 text-[#101F46] group-hover:bg-amber-300 transition-colors">
                <svg
                  width="22"
                  height="22"
                  viewBox="0 0 24 24"
            ...
            <a
              ...
              className="group flex items-center gap-4 p-5 border-2 border-[#eae6de] hover:border-amber-400 hover:bg-amber-50 transition-all duration-200"
            >
              <div className="w-12 h-12 bg-[#101F46] flex items-center justify-center shrink-0 text-amber-400 group-hover:bg-[#162e57] transition-colors">
                <svg
                  width="22"
                  height="22"
                  viewBox="0 0 24 24"
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 relative">
            {[
              ...
              >
                <p className="text-[7rem] font-bold text-[#101F46]/[0.05] leading-none select-none absolute top-4 right-6">
                  {item.step}
                </p>
                <p className="text-amber-500 font-bold text-xs tracking-widest uppercase mb-3">
                  Step {item.step}
                </p>
                <h3 className="font-bold text-[#101F46] text-xl mb-3 relative">
                  {item.title}
                </h3>
              ...
              <button
                ...
                className={`px-5 py-2.5 font-bold text-sm transition-all duration-200 border-b-2 -mb-px ${
                  activeStream === key
                    ...
                    : "border-transparent text-slate-400 hover:text-[#101F46]"
                }`}
              >
                {streams[key].label}
              </button>
              ...
              >
                <div className="flex items-start gap-8 p-8">
                  <div className="shrink-0 pt-1">
                    <p className="text-5xl font-bold text-[#101F46]/10 leading-none select-none">
                      {step.num}
                    </p>
                  </div>
                  <div className="flex-1">
                    ...
                    <div className="mb-5">
                      <p className="font-bold text-[#101F46] mb-3 text-xs uppercase tracking-wider">
      ...
      {/* Scholarships */}
      <section id="scholarships" className="py-24 bg-[#101F46]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-14">
            <div>
                ...
                {timeline.map((item, i) => (
                  <div key={i} className="flex gap-8 group pl-8 relative">
                    ...
                    <div className="flex-1 pb-8">
                      ...
                      <h3 className="font-bold text-[#101F46] mb-1">
                        {item.event}
                      </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="text-[#101F46]">
                  <IconDoc size={22} />
                </div>
                <h3 className="text-lg font-bold text-[#101F46]">
                  Required Documents
                </h3>
              </div>
                ...
                {[
                  ...
                  >
                    <div className="flex items-center justify-between mb-1">
                      <span className="font-bold text-[#101F46] text-sm">
                        {s.stream} Stream
                      </span>
      ...
      <section className="py-24 bg-[#101F46]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-t border-white/10 pt-10 mb-14">
            ...
            <Link
              href="/faq"
              className="shrink-0 inline-flex items-center gap-2 px-6 py-3 bg-amber-400 text-[#101F46] font-bold rounded-xl hover:bg-amber-300 transition-colors text-sm"
            >
              View FAQ <IconArrow />
            </Link>
          </div>
          ...
          <div className="text-center">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-10 py-4 bg-amber-400 text-[#101F46] font-bold rounded-xl hover:bg-amber-300 transition-colors shadow-lg shadow-amber-400/20"
            >
              Contact Admissions
              <IconArrow />
            </Link>
