        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 border-t border-[#eae6de] pt-16">
            <div className="max-w-xl">
              ...
              <h2 className="text-3xl font-bold text-[#0B1F3A] mb-3">Join Our Team</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3 shrink-0">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-[#0B1F3A] text-white font-semibold rounded-xl hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200"
              >
                <IconMail size={17} />
                Send Your CV
              </a>
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-7 py-3.5 border border-[#d1cdc5] text-[#0B1F3A] font-semibold rounded-xl hover:border-amber-400 transition-all duration-200"
              >
                <IconPhone size={17} />
                {SITE_CONFIG.phone}
              </a>
