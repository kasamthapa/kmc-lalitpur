          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {bioParas.length > 0 && (
              <div className="pb-8 border-b border-[#e8e4dc]">
                <h2
                  className="text-[#0B1F3A] font-bold text-xs tracking-[0.15em] uppercase mb-5 border-b-2 pb-2"
            ...
            <Link href="/campus/faculty" className="inline-flex items-center gap-2 text-sm font-bold text-[#0B1F3A] hover:text-amber-600 transition-colors mt-4">
              ← All Faculty
            </Link>
          </div>
            ...
            <div className="divide-y divide-[#e8e4dc]">
              <div className="py-4 flex flex-col gap-1">
                ...
                <div className="flex items-start gap-3 mt-1">
                  ...
                  <p className="text-sm text-[#0B1F3A] font-semibold self-center">{member.qualification}</p>
                </div>
              </div>
              ...
              <div className="py-4 flex flex-col gap-1">
                ...
                <div className="flex items-start gap-3 mt-1">
                  ...
                  <p className="text-sm text-[#0B1F3A] font-semibold self-center">{member.experience}</p>
                </div>
              </div>
