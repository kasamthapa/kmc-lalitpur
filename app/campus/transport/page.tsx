...
export default function TransportPage() {
  return (
    <main className="bg-white">
      ...
      {/* Hero */}
      <section className="pt-28 pb-16 bg-[#101F46] text-white">
      ...
      <section className="bg-amber-400 py-5">
        <div className="max-w-7xl mx-auto px-4 flex items-center gap-4">
          <div className="w-10 h-10 rounded-full bg-[#101F46]/10 flex items-center justify-center shrink-0">
            <IconMapPin size={20} className="text-[#101F46]" />
          </div>
          <p className="text-[#101F46] font-semibold text-base leading-snug">
      ...
      <section className="py-20 bg-[#f7f5f0]">
        <div className="max-w-6xl mx-auto px-4">
              ...
              return (
                ...
                >
                  ...
                  <div className={`${m.headerBg} px-5 py-4 flex items-center gap-3 border-b ${m.border}`}>
                    ...
                    />
                    <h3 className="font-bold text-[#101F46] text-lg">{zone}</h3>
          ...
          <div className="mt-8 bg-white border border-[#eae6de] rounded-2xl p-6 flex items-start gap-4">
            ...
            <div>
              <p className="font-bold text-[#101F46] mb-1">Don&apos;t see your area?</p>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-amber-400 text-[#101F46] font-bold rounded-xl hover:bg-amber-300 transition"
            >
              <IconPhone size={18} />
              {SITE_CONFIG.phone}
            </a>
