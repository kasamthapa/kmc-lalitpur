          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-end">
            <div>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-7 py-3.5 bg-amber-400 text-[#101F46] font-bold rounded-xl hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200"
              >
                <IconPhone size={17} />
                Inquire Now
              </a>
            ...
            <div className="grid grid-cols-2 gap-px bg-white/10 rounded-2xl overflow-hidden">
              {[
                ...
                <div key={s.label} className="bg-[#101F46] px-8 py-8">
              ...
              <div className="divide-y divide-[#eae6de]">
                {amenities.map((item, i) => (
                  <div key={item} className="flex items-start gap-5 py-4 group">
                    ...
                    <span className="text-[#374151] text-sm leading-relaxed group-hover:text-[#101F46] transition">
                      {item}
                    </span>
                  </div>
                ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.title} className="flex gap-4">
                ...
                <div>
                  <h3 className="font-bold text-[#101F46] mb-2">{item.title}</h3>
