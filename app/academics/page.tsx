...
export default function Academics() {
  return (
    <main className="bg-white pt-[100px]">
          ...
          <div className="flex flex-wrap gap-3 mt-10">
            {streams.map((s) => (
              <a
                key={s.id}
                href={`#${s.id}`}
                className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-amber-400 hover:text-[#101F46] text-white text-sm font-semibold rounded-lg transition-all duration-200 border border-white/20 hover:border-amber-400"
              >
                <span className="text-amber-400 hover:text-[#101F46]">
                  {s.icon}
                </span>
                {s.shortTitle}
              </a>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4 mb-12">
              ...
              <div>
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-[#101F46]">
                  {stream.title}
                </h2>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
              ...
              <div className="lg:col-span-2 flex flex-col gap-5">
                <div className="relative h-64 rounded-xl overflow-hidden shadow-lg">
                  <Image
                    ...
                    className="object-cover"
                  />
                  <div className="absolute inset-0 bg-linear-to-t from-[#101F46]/60 to-transparent pointer-events-none" />
                ...
                {/* Entrance exam box */}
                <div className="bg-[#101F46] rounded-xl p-6 text-white">
                ...
                {"timing" in stream && (
                  <div className="bg-amber-400/10 border border-amber-400/30 rounded-lg p-5">
                    ...
                    <p className="text-[#101F46] text-sm font-medium leading-relaxed">
              ...
              <div className="lg:col-span-3 space-y-8">
                ...
                {/* Subjects */}
                <div>
                  <h3 className="font-bold text-[#101F46] mb-4 text-sm uppercase tracking-wider">
                    Subjects
                  </h3>
                  {stream.id === "law" ? (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <span className="text-2xl font-bold text-[#101F46]">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {stream.features.map((f, i) => (
                      ...
                      >
                        <span className="w-5 h-5 rounded-full bg-amber-400 flex items-center justify-center shrink-0 mt-0.5 text-[#101F46]">
                          <IconStar />
                        </span>
                        {f}
                      </li>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {stream.careers.map((c) => (
                      <span
                        key={c}
                        className="px-3 py-1.5 bg-[#101F46] text-white text-xs font-semibold rounded-lg"
                      >
                        {c}
                      </span>
                    ))}
      ...
      {/* Teaching Approach */}
      <section className="py-24 bg-[#101F46]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4">
            <div className="bg-white/5 border border-white/10 rounded-xl p-8 flex flex-col sm:flex-row gap-6 hover:border-amber-400/30 transition-colors duration-200">
              <div className="w-10 h-10 rounded-lg bg-amber-400 flex items-center justify-center text-[#101F46] font-bold text-sm shrink-0">
                01
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {teachingApproach.slice(1).map((item, i) => (
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-amber-400 flex items-center justify-center text-[#101F46] font-bold text-sm mb-5 shrink-0">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#e8e8e8] rounded-xl overflow-hidden">
            {[
              ...
              >
                <div className="w-12 h-12 bg-amber-400 rounded-lg flex items-center justify-center text-[#101F46] mb-6">
                  {item.icon}
                </div>
                <h3 className="text-lg font-bold text-[#101F46] mb-3">
                  {item.title}
                </h3>
                <p className="text-slate-600 leading-relaxed text-sm">
                  {item.desc}
          ...
          <div className="mt-10">
            <Link
              href="/campus/faculty"
              className="inline-flex items-center gap-2 text-[#101F46] font-bold hover:text-amber-600 transition-colors group text-sm"
            >
              Meet Our Faculty
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              >
                <div className="w-12 h-12 rounded-lg bg-[#101F46] flex items-center justify-center text-amber-400 shrink-0 group-hover:bg-amber-400 group-hover:text-[#101F46] transition-colors">
                  <span className="font-bold text-sm">
                    {String(i + 1).padStart(2, "0")}
                  </span>
                </div>
                <div>
                  <h3 className="font-bold text-[#101F46] mb-2">
                    {item.title}
                  </h3>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
            ...
            <p className="text-slate-500 text-sm leading-relaxed max-w-xs md:text-right">
              ...
              collaboration with{" "}
              <strong className="text-[#101F46]">NCC Education (UK)</strong> —
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={i}
                className="bg-[#101F46] rounded-xl p-7 flex flex-col hover:shadow-2xl transition-shadow duration-200"
              >
          ...
          <div className="mt-8 bg-amber-50 border border-amber-200 rounded-xl p-6 flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <div className="shrink-0 px-5 py-3 bg-[#101F46] text-amber-400 rounded-lg text-xs font-bold text-center">
              NCC Education
              <br />
      ...
      {/* CTA */}
      <section className="py-20 bg-[#101F46] relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/admissions"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-amber-400 text-[#101F46] font-bold rounded-lg hover:bg-amber-300 transition-colors"
            >
