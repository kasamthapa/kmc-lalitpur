...
export default function Contact() {
  ...
  return (
    <main className="bg-white pt-25">
      ...
      {/* Hero */}
      <section className="relative pt-28 pb-20 bg-[#101F46] overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
            ...
            <div className="lg:col-span-3">
              ...
              {submitted ? (
                <div className="bg-white p-10 border border-[#e8e8e8] text-center">
                  <div className="w-12 h-12 bg-amber-400 rounded-full flex items-center justify-center mx-auto mb-5 text-[#101F46]">
                    <IconCheck />
                  </div>
                  <h3 className="text-xl font-bold text-[#101F46] mb-3">
                    Message Sent
                  </h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-xs font-semibold text-[#101F46] mb-2 uppercase tracking-wider">
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 border-b-2 bg-white text-sm text-[#101F46] placeholder-slate-400 focus:outline-none focus:border-amber-400 transition-colors ${fieldErrors.name ? "border-red-400" : "border-[#e0dcd4]"}`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        placeholder="+977"
                        className="w-full px-4 py-3 border-b-2 border-[#e0dcd4] bg-white text-sm text-[#101F46] placeholder-slate-400 focus:outline-none focus:border-amber-400 transition-colors"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border-b-2 bg-white text-sm text-[#101F46] placeholder-slate-400 focus:outline-none focus:border-amber-400 transition-colors ${fieldErrors.email ? "border-red-400" : "border-[#e0dcd4]"}`}
                    />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 border-b-2 bg-white text-sm text-[#101F46] placeholder-slate-400 focus:outline-none focus:border-amber-400 transition-colors ${fieldErrors.subject ? "border-red-400" : "border-[#e0dcd4]"}`}
                      />
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className="w-full px-4 py-3 border-b-2 border-[#e0dcd4] bg-white text-sm text-[#101F46] focus:outline-none focus:border-amber-400 transition-colors"
                      >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={5}
                      className={`w-full px-4 py-3 border-b-2 bg-white text-sm text-[#101F46] placeholder-slate-400 focus:outline-none focus:border-amber-400 transition-colors resize-none ${fieldErrors.message ? "border-red-400" : "border-[#e0dcd4]"}`}
                    />
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="inline-flex items-center gap-2 px-8 py-4 bg-amber-400 text-[#101F46] font-bold rounded-xl hover:bg-amber-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-amber-400/20"
                  >
                    {loading ? (
                      <>
                        <svg
            ...
            <div className="lg:col-span-2 flex flex-col gap-10">
              {/* Map */}
              <div>
                <h3 className="font-bold text-[#101F46] mb-4 text-lg">Visit Our Campus</h3>
                ...
                <a
                  ...
                  className="mt-3 flex items-center gap-2 text-sm font-semibold text-[#101F46] hover:text-amber-600 transition-colors"
                >
                  <IconMapPin size={16} />
              ...
              <div>
                <h3 className="font-bold text-[#101F46] mb-5 text-lg">Contact Information</h3>
                <div className="space-y-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href={SITE_CONFIG.phoneHref} className="text-sm text-[#101F46] font-semibold hover:text-amber-600 transition-colors">{SITE_CONFIG.phone}</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${SITE_CONFIG.email}`} className="text-sm text-[#101F46] font-semibold hover:text-amber-600 transition-colors block">{SITE_CONFIG.email}</a>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href={SITE_CONFIG.address.mapsUrl} target="_blank" rel="noopener noreferrer" className="text-sm text-[#101F46] font-semibold hover:text-amber-600 transition-colors">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[#101F46] font-semibold">Sun – Fri: 8 AM – 5 PM</p>
              ...
              <div>
                <h3 className="font-bold text-[#101F46] mb-4 text-lg">By Department</h3>
                <div className="space-y-3">
                  {departments.map((dept, i) => (
                    <div key={i} className="pb-3 border-b border-[#eae6de] last:border-0">
                      <p className="font-semibold text-[#101F46] text-sm mb-1">{dept.name}</p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2.5 px-5 py-3 bg-white border border-[#e8e8e8] text-[#101F46] font-bold text-sm hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2] transition-all"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2.5 px-5 py-3 bg-white border border-[#e8e8e8] text-[#101F46] font-bold text-sm hover:bg-[#E1306C] hover:text-white hover:border-[#E1306C] transition-all"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2.5 px-5 py-3 bg-white border border-[#e8e8e8] text-[#101F46] font-bold text-sm hover:bg-[#FF0000] hover:text-white hover:border-[#FF0000] transition-all"
              >
