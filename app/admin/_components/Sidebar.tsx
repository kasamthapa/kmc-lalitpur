...
export function Sidebar({ userName }: { userName: string }) {
    ...
    <>
      <div className="px-4 py-6 border-b border-gray-800">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-full bg-amber-400 flex items-center justify-center font-bold text-gray-900 text-sm shrink-0">
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="hidden lg:flex flex-col w-60 bg-gray-950 shrink-0 h-screen sticky top-0">
        <div className="px-5 py-5 border-b border-gray-800">
          <p className="text-white font-bold text-lg tracking-tight">KMC Admin</p>
          <p className="text-gray-500 text-xs mt-0.5">Content Management</p>
        </div>
        <NavLinks />
      </aside>
      ...
      <div className="lg:hidden flex items-center justify-between px-4 py-3 bg-gray-950 border-b border-gray-800 sticky top-0 z-30">
        <p className="text-white font-bold">KMC Admin</p>
        <button
        ...
        <div className="lg:hidden fixed inset-0 z-40 flex">
          <div className="w-64 bg-gray-950 flex flex-col">
            <div className="px-5 py-5 border-b border-gray-800 flex items-center justify-between">
              <p className="text-white font-bold text-lg">KMC Admin</p>
