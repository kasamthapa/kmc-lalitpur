    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-4 border-b border-gray-200 shrink-0">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-gray-900 font-bold text-[13px] leading-none">KMC Admin</p>
            <p className="text-gray-400 text-[10px] mt-0.5">Content Management</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-3 border-b border-gray-200 shrink-0">
        <div className="flex items-center gap-2.5">
          ...
          <div className="min-w-0">
            <p className="text-gray-800 font-semibold text-xs truncate leading-none">{userName}</p>
            <p className="text-gray-400 text-[10px] mt-0.5">Administrator</p>
          </div>
        </div>
      </div>
      ...
      <nav className="flex-1 overflow-y-auto px-2.5 py-3 space-y-4">
        {NAV_GROUPS.map((group) => (
          <div key={group.label}>
            <p className="text-[9px] font-bold text-gray-400 uppercase tracking-[0.14em] px-2 mb-1">
              {group.label}
            </p>
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center gap-2.5 px-2 py-2 rounded-md text-[12.5px] font-medium transition-all duration-100 border-l-2 ${
                      active
                        ? "border-amber-400 bg-amber-50 text-amber-700 pl-[6px]"
                        : "border-transparent text-gray-500 hover:bg-gray-50 hover:text-gray-800 pl-[6px]"
                    }`}
                  >
      ...
      {/* Footer actions */}
      <div className="px-2.5 py-3 border-t border-gray-200 shrink-0 space-y-px">
        <Link
          href="/"
          target="_blank"
          onClick={onClose}
          className="flex items-center gap-2.5 px-2 py-2 rounded-md text-[12.5px] text-gray-500 hover:bg-gray-50 hover:text-gray-800 transition-all pl-[6px] border-l-2 border-transparent"
        >
        ...
        <button
          ...
          className="w-full flex items-center gap-2.5 px-2 py-2 rounded-md text-[12.5px] text-gray-500 hover:bg-red-50 hover:text-red-600 transition-all pl-[6px] border-l-2 border-transparent"
        >
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-white border-b border-gray-200 sticky top-0 z-30">
        <div className="flex items-center gap-2">
          ...
          <p className="text-gray-900 font-bold text-sm">KMC Admin</p>
        </div>
        <button
