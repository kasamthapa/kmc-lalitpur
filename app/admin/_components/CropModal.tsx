...
export function CropModal({ imageSrc, onDone, onSkip, onCancel }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-black/90">
      <div className="bg-gray-900 border border-white/[0.08] rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-4 border-b border-white/[0.06]">
          ...
          <button onClick={onCancel} className="text-gray-500 hover:text-white transition-colors p-1 rounded-lg hover:bg-white/[0.06]">
        ...
        <div className="flex gap-3 p-5">
          <button
            onClick={onSkip}
            className="flex-1 py-2.5 bg-white/[0.06] hover:bg-white/[0.1] text-gray-300 text-sm font-semibold rounded-lg transition-colors"
          >
            Skip crop
          </button>
          <button
