        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="flex-1 min-w-0">
            ...
            {featured && (
              <Link href={`/blog/${featured.slug}`} className="group block mb-16">
                ...
                <div className="relative w-full aspect-[21/9] bg-[#101F46] overflow-hidden">
                  <Image
                ...
                <div className="mt-7 border-l-[3px] border-amber-400 pl-7">
                  ...
                  <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#101F46] leading-[1.15] mb-4 group-hover:text-[#1a3a6a] transition">
                    {featured.title}
                  </h2>
                  {featured.excerpt && (
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-sm text-[#9ca3af]">
                    ...
                    <span className="ml-auto inline-flex items-center gap-2 text-[#101F46] font-bold text-sm group-hover:gap-3 transition-all">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12">
                  {rest.map((post) => (
                    ...
                    >
                      ...
                      <h3 className="font-bold text-[#101F46] text-xl leading-snug mb-2 group-hover:text-[#1a3a6a] transition line-clamp-2">
                        {post.title}
                      </h3>
                      {post.excerpt && (
            ...
            {filtered.length === 0 && (
              <div className="text-center py-24">
                ...
                <h3 className="text-xl font-bold text-[#101F46] mb-2">
                  No posts found
                </h3>
          ...
          <aside className="w-full lg:w-60 shrink-0">
            <div className="lg:sticky lg:top-[140px] space-y-10">
              ...
              {/* Categories */}
              <div>
                <h3 className="text-[11px] font-bold tracking-[0.2em] uppercase text-[#374151] pb-3 border-b-2 border-[#101F46]">
                  Categories
                </h3>
                <ul>
                      ...
                      <li key={cat}>
                        ...
                        >
                          <span
                            className={
                              activeCategory === cat
                                ? "font-bold text-[#101F46]"
                                : "text-[#374151] group-hover:text-[#101F46] transition"
                            }
                          >
                            {cat}
                          </span>
              ...
              <div>
                ...
                <div>
                  {recentPosts.map((post) => (
                    ...
                    >
                      <div className="relative w-14 h-12 overflow-hidden shrink-0 bg-[#101F46]">
                        <Image
                          src={post.imageUrl ?? fallbackImage}
                          alt={post.title}
                          fill
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-[#101F46] line-clamp-2 group-hover:text-amber-600 transition leading-snug">
                          {post.title}
                        </p>
              ...
              <div className="border-t-2 border-[#101F46] pt-6">
                ...
                <input
                  ...
                  className="w-full py-2.5 bg-transparent border-b-2 border-[#d1d5db] text-[#101F46] placeholder:text-[#9ca3af] text-sm focus:outline-none focus:border-amber-500 mb-4"
                />
                <button className="w-full py-2.5 bg-[#101F46] text-white text-sm font-bold hover:bg-[#162f55] transition">
                  Subscribe
                </button>
              </div>
            </div>
