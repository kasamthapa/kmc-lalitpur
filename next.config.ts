        ...
        headers: [
          ...
          { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=()" },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://res.cloudinary.com https://img.youtube.com https://i.ytimg.com https://maps.gstatic.com https://maps.googleapis.com https://*.ggpht.com https://*.basemaps.cartocdn.com https://*.tile.openstreetmap.org",
              ...
              "connect-src 'self' https://generativelanguage.googleapis.com https://vitals.vercel-insights.com https://maps.googleapis.com https://api.cloudinary.com https://res.cloudinary.com https://*.basemaps.cartocdn.com https://*.tile.openstreetmap.org",
              "font-src 'self' data:",
